package com.yokudlela.dailymenu.controller.dish;
...
@Path(ControllerConstant.DISH_PATH)
public class DishController {

    public static final String GET_ALL_ACTIVE_DISHES = ControllerConstant.SLASH + "findByActiveEqualsTrue";
    public static final String GET_DISH_BY_NAME_AND_ACTIVE = ControllerConstant.SLASH + "findByNameAndActive";
    public static final String GET_DISH_BY_ID = ControllerConstant.SLASH + ControllerConstant.ID_PARAM;
