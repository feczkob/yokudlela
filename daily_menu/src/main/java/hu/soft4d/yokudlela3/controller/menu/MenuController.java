package hu.soft4d.yokudlela3.controller.menu;
...
import hu.soft4d.yokudlela3.controller.menu.model.request.MenuRequest;
import hu.soft4d.yokudlela3.controller.menu.model.response.MenuListResponse;
import hu.soft4d.yokudlela3.controller.menu.model.response.MenuResponse;
...
public class MenuController {
    ...
    public static final String GET_MENU_BY_DAY = SLASH + "findMenuByDay";
    public static final String GET_MENU_BETWEEN_DAYS = SLASH + "findMenusBetweenDayFromDayTo";
    public static final String GET_MENU_BY_ID = SLASH + ControllerConstant.ID_PARAM;
