package hu.soft4d.yokudlela3.controller.menuitem;

import static hu.soft4d.yokudlela3.controller.ControllerConstant.MENU_ITEM_ENUM_PATH;
...
import hu.soft4d.yokudlela3.controller.menuitem.model.request.MenuItemAmountRelatedRequest;
import hu.soft4d.yokudlela3.controller.menuitem.model.request.MenuItemRequest;
import hu.soft4d.yokudlela3.controller.menuitem.model.response.MenuItemCategoryListResponse;
import hu.soft4d.yokudlela3.controller.menuitem.model.response.MenuItemListResponse;
import hu.soft4d.yokudlela3.controller.menuitem.model.response.MenuItemResponse;
import hu.soft4d.yokudlela3.controller.menuitem.model.response.MenuItemSectionListResponse;
import hu.soft4d.yokudlela3.controller.menuitem.model.response.MenuItemVariantListResponse;
...
public class MenuItemController {
    ...
    @Operation(summary = "Searching menu item by day")
    @GET
    @Path(SLASH + "findMenuItemsDayFromDayTo")
    ...
    @GET
    @Path(SLASH + ControllerConstant.ID_PARAM)
    ...
    @PATCH
    @Path(SLASH + "claim" + SLASH + ControllerConstant.ID_PARAM)
    ...
    @PATCH
    @Path(SLASH + "done" + SLASH + ControllerConstant.ID_PARAM)
    ...
    @PATCH
    @Path(SLASH + "pay" + SLASH + ControllerConstant.ID_PARAM)
    ...
    @Path(MENU_ITEM_ENUM_PATH + SLASH + "category")
    @GET
    ...
    @Path(MENU_ITEM_ENUM_PATH + SLASH + "section")
    @GET
    ...
    @Path(MENU_ITEM_ENUM_PATH + SLASH + "variant")
    @GET
