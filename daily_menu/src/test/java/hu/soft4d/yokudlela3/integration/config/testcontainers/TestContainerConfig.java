package hu.soft4d.yokudlela3.integration.config.testcontainers;
...
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_ADMIN_FIRSTNAME;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_ADMIN_LASTNAME;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_ADMIN_PASSWORD;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_MANAGER;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_MANAGER_FIRSTNAME;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_MANAGER_LASTNAME;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.DAILYMENU_MANAGER_PASSWORD;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.KEYCLOAK_REALM;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.PROFILE;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.QUARKUS_OIDC_AUTH_SERVER_URL;
import static hu.soft4d.yokudlela3.integration.IntegrationTestConstant.TEST;
...
public class TestContainerConfig implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        createTestUser(DAILYMENU_ADMIN, DAILYMENU_ADMIN_FIRSTNAME, DAILYMENU_ADMIN_LASTNAME,
                        DAILYMENU_ADMIN_PASSWORD,
        ...
        createTestUser(DAILYMENU_MANAGER, DAILYMENU_MANAGER_FIRSTNAME, DAILYMENU_MANAGER_LASTNAME,
                        DAILYMENU_MANAGER_PASSWORD,
                        List.of(RoleConstant.MANAGER_ROLE, RoleConstant.DISH_CLAIM_REQUEST_ROLE,
                                RoleConstant.DISH_PAID_ROLE));

        return Map.of(
                "quarkus.profile", PROFILE,
                ...
                QUARKUS_OIDC_AUTH_SERVER_URL, KEYCLOAK_SERVER_URL + "/realms/" + KEYCLOAK_REALM);
    }
    ...
    private void createTestUser(String emailAsUsername, String firstName, String lastName, String password,
        ...
        final RealmResource realm = keycloakAdminClient.realm(KEYCLOAK_REALM);
        ...
        final String userId = location.substring(location.lastIndexOf(SLASH) + 1);
